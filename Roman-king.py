...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mRoman Khan 
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801881482391
\x1b[93;1m Facebook       \x1b[92;1m=>      \x1b[93;1mMd Babul Islam 
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
...
def menu(): #Bilo
	...
	if farhan in ['1','01']:
		...
		os.system("https://www.facebook.com/Hi.Baby.Its.Me.roman.king.20b")
		exit()
...
def crack2(idf,pwv):
	...
	fff = '%'
	print('\r%s [ROMAN] %s/%s  OK*%s | CP*%s => %s%s%s'%(bi,loop,len(id2),ok,cp,int(pers),str(fff),x), end=' ');sys.stdout.flush()
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ROMAN-CP] %s|%s        '%(b,idf,pw))
